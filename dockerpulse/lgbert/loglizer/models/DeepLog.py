...
class DeepLog(nn.Module):
    def __init__(self, num_labels, hidden_size=100,
                 num_directions=2, topk=9, device="cpu"):
    ...
    def fit(self, train_loader, epoches=10):
        ...
        for epoch in range(epoches):
            ...
            print("Epoch {}/{}, training loss: {:.5f}".format(epoch +
                  1, epoches, epoch_loss))
    ...
    def evaluate(self, test_loader):
        ...
        with torch.no_grad():
            ...
            store_df["anomaly"] = store_df.apply(
                lambda x: x["window_y"] not in x["topk_indice"], axis=1).astype(int)
